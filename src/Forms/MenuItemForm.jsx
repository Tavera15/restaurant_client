...
function MenuItemForm({item, btnText, num, btnAction})
{
    ...
    async function createNewCategory()
    {
        ...
        await axios.post(import.meta.env.VITE_SERVER_API + "/Category/CreateCategory", data, {headers: {Authorization: token}})
    ...
    */
    ...
    function handleSubmit(e)
    {
        ...
        {
            alert("Item must have a name and category");
            return;
        }
                ...
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content bg-dark">
                        <div className="modal-header">
                            <input placeholder="Menu Item Name" required value={itemName} onChange={(e) => setItemName(e.target.value)} />
